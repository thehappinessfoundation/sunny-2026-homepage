    ...
    <div className="min-h-screen pt-40 md:pt-56 pb-32">
      <div className="container-pc !max-w-[1000px]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6 relative">
          ...
          <div className="absolute right-0 top-0 -translate-y-[20%] md:-translate-y-[40%] z-0 pointer-events-none opacity-80 mix-blend-lighten">
            <img src="/newsroom.png" alt="See the new" className="h-[250px] md:h-[500px] object-contain drop-shadow-xl opacity-90" />
          </div>
        </div>
